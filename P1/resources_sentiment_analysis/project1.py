...
def hinge_loss_single(feature_vector, label, theta, theta_0):
    ...
    """
    # Your code here
    # classifier argument, correctly classified when argument C > 0  
    # hinge function L still defined within 1/norm(theta) margin

    C = label*(np.dot(feature_vector, theta) + theta_0)  
...
def hinge_loss_full(feature_matrix, labels, theta, theta_0):
    ...
    """
    # Your code here
    [k,m] = np.shape(feature_matrix) # kth sample each with m features 
    L = []

    # iterating by index
    for i in range(k):
        # list can apeend 
        L.append(hinge_loss_single(feature_matrix[i], labels[i], theta, theta_0))
    
    # average hinge loss along all k data points
    return sum(L)/k # np.sum will sum all the elements as well
#pragma: coderesponse end
...
def perceptron_single_step_update(
    ...
    completed.
    """
    # print('sss',current_theta_0)
    # print(label)
    # print(current_theta)
    # print(current_theta_0)
    # Your code here
    # update only if data is miss-classified 

    # convert input as np.array tp keep format consistency 
...
def perceptron(feature_matrix, labels, T):
    ...
    # default return already in tuple format 
...
def pegasos_single_step_update(
    ...
    if label*(np.dot(feature_vector, current_theta) + current_theta_0) <= 1:
        ...
        current_theta_0 = current_theta_0 + eta*label # update wo penalty 
    else:
        current_theta = (1 - eta*L)*current_theta
        # current_theta_0 = (1 - eta)*current_theta_0
        # theta_0 not update 
...
def classify(feature_matrix, theta, theta_0):
    ...
    """
    # Your code here
    # n samples each with d features 
...
def extract_bow_feature_vectors(reviews, dictionary):
    ...
    for i, text in enumerate(reviews):
        word_list = extract_words(text)
        for word in word_list:
            n = word_list.count(word) # count 
            
            if word in dictionary:
                feature_matrix[i, dictionary[word]] = n # count
                # feature_matrix[i, dictionary[word]] = 1 # binary 
