...
# already know Pegasos is the alg for our training data
# so apply test set to pretrained model and return its accuracy 
...
# # parameters are from tuning
# T = 25
# L = 0.01

# # extract the best theta wo bias from selected alg which is pegosos 
