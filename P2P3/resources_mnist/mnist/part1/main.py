...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    # implicit recalculate test error
    # only difference is how to calculate error
    # replace compute_test_error to compute_test_error_mod3
...
# print('softmax test_error_mod3=', run_softmax_on_MNIST_mod3(temp_parameter=0.5))
# print('softmax test_error_mod3=', run_softmax_on_MNIST_mod3(temp_parameter=1))
# print('softmax test_error_mod3=', run_softmax_on_MNIST_mod3(temp_parameter=2))
...
def run_softmax_on_MNIST_pca(temp_parameter=1):
    ...
    nimage_reconstructed = reconstruct_PC(train_pca[0:n_components, ], pcs, n_components, train_x)
...
# print('softmax test_error_pca_cube=', run_softmax_on_MNIST_pca_cube(temp_parameter=1))
